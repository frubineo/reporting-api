# Certification Archive Generator for reporting-api
Write-Host "Generating certification archive for reporting-api..." -ForegroundColor Green

$ProjectName = "reporting-api"
$Version = "v1.0.0"
...
$CertificationManifest = "# reporting-api Certification Manifest
