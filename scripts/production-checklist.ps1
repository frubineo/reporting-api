# Production Checklist for reporting-api
Write-Host "Production Checklist for reporting-api" -ForegroundColor Cyan
...
Test-Requirement "Archive" ((Get-ChildItem -Name "reporting-api-v1.0.0-production-certified-*.zip" -ErrorAction SilentlyContinue).Count -gt 0)
